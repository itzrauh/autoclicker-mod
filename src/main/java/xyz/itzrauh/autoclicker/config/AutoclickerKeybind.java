...
public class AutoclickerKeybind {
    ...
    private static final KeyBinding.Category CATEGORY = KeyBinding.Category.create(Identifier.of(AutoclickerMod.MOD_ID, "keybinds"));

    @Getter private static KeyBinding toggleKey;

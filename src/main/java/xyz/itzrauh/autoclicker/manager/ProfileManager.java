...
public class ProfileManager {
    ...
    public static int createProfile(String name) {
        List<ConfigProfile> profiles = getProfiles();
    ...
    public static void setActiveName(String name) {
        List<ConfigProfile> profiles = getProfiles();
        getActive().setName(sanitizeName(name, profiles));
        save();
    }

    public static void setActiveDelay(int delayMs) {
        getActive().setDelayMs(Math.max(MIN_DELAY, Math.min(MAX_DELAY, delayMs)));
        save();
    }
